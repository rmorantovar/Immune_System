...
for i_model, energy_model in enumerate(energy_models):
    ...
    df = pd.read_csv(Text_files_path + 'exponential_proofreading/E_model/All_data_' + energy_model + '.csv')
    f = open(Text_files_path + 'exponential_proofreading/E_model/trajectories_'+energy_model+'.pkl', 'rb')
    ...
    fig_Omega.savefig(output_plot + 'energy_model.pdf')
    ...
    fig_betas.savefig(output_plot + 'betas.pdf')
    ...
    fig_K_r.savefig(output_plot + 'K_r.pdf')
    ...
    fig_K_m.savefig(output_plot + 'K_m.pdf')
    ...
    fig_l_sigma.savefig(output_plot + 'l_vs_std.pdf')
