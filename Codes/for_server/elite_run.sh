...
n_ens=$((1000+$SLURM_ARRAY_TASK_ID))

echo "Start"

cd $srcdir
echo "./primary_immune_response.x -a 6 -b 3 -k 12 -t 0 -T 7.0 -E TCRen -C 100000000 -B 100000000 -s TACNSEYPNTTRAKCGRWYC -q 3.0 --ensemble -N $n_ens"
./primary_immune_response.x -a 6 -b 3 -k 12 -t 0 -T 7.0 -E TCRen -C 100000000 -B 100000000 -s TACNSEYPNTTRAKCGRWYC -q 3.0 --ensemble -N $n_ens
cd ~
