...
cd $srcdir
echo "primary_immune_response.py --N_ens 400 --L0 1000000000 --t_lim $t_lim --E_lim -8.5 --E_m -24 --chunk_size 100000000 --p $p --k_step 720 --n_jobs 50"
python primary_immune_response.py --N_ens 400 --L0 1000000000 --t_lim $t_lim --E_lim -8.5 --E_m -24 --chunk_size 100000000 --p $p --k_step 720 --n_jobs 50
cd ~
