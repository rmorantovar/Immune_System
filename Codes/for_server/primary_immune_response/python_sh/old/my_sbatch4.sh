...
cd $srcdir
echo "python primary_immune_response.py --N_ens 400 --L0 1000000000 --t_lim 7 --E_lim -12.0 --E_m -24 --chunk_size 100000000 --p $p --k_step 288"
python primary_immune_response.py --N_ens 400 --L0 1000000000 --t_lim 7 --E_lim -12.0 --E_m -24 --chunk_size 100000000 --p $p --k_step 288
cd ~
