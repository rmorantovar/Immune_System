...
cd $srcdir
echo "./primary_immune_response.x -a 6 -b 3 -k 12 -t 0 -T 7.0 -E TCRen -C 100000000 -B 100000000 -s TACNSEYPNTTRAKCGRWYC -q $p"
./primary_immune_response.x -a 6 -b 3 -k 12 -t 0 -T 7.0 -E TCRen -C 100000000 -B 100000000 -s TACNSEYPNTTRAKCGRWYC -q $p
cd ~
