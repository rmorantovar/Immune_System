...
{
	string Text_files_path = "/home/rmorantovar/text_files/";
    ...
    ifstream file("/home/rmorantovar/Input_files/"+energy_model+".txt");
    ...
    ifstream file2("/home/rmorantovar/Input_files/Alphabet_"+energy_model+".txt");
    ...
    if(ensemble_flag){ // ENSEMBLE OF TRAJECTORIES
    	...
    	std::ofstream fout(Text_files_path+"Ensemble/"+parameters_path+"/energies_ensemble_active.bin", std::ios::binary);
