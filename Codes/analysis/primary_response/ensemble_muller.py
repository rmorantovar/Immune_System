    ...
    for N_ens in N_enss:
        ...
        #for i_ens in tqdm(n_ens): #38 aging, 332 elit ----- 689.0 at 1030
            ...
            if (Potency>2.80863588e11/1000):
                ...
                #ax_muller.vlines([t_act_theory, t_fs[i_kappa]], 0, 1, color = 'black', linewidth = 2, alpha = 1, linestyles = ['--', ':'])
                ...
                fig_muller.savefig('../../Figures/1_Dynamics/Ensemble/L%d/Mullers/Clones_N_r%.e_N_ens-%d_n_ens-%d_Z-%.2e_'%(L, N_r, N_ens, i_ens, Potency/2.80863588e11)+energy_model+'.pdf', edgecolor=fig_muller.get_edgecolor())
