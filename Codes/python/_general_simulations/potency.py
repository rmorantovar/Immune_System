...
def main():
	...
	parser.add_argument('--N_epi', type=int, default=1, help="Number of epitopes.")
	...
	parser.add_argument('--p', type=float, default=4, help="Number of steps.")
	...
	parser.add_argument('--subpro', type=str, default='minimal_ID', help="Subproject name.")
