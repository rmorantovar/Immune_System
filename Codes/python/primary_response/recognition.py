...
def main():
    ...
    # Change here the directory based on the current project.
    project = 'primary_immune_response'
    subproject = 'simulations_lambda_A'
    ...
    for antigen in antigens:
        ...
        process_ensemble(motif, np.cumsum(Q0[:-1]*dE)[::100], Es[:-1][::100], N_ens, L0, l, t_lim, E_lim, E_m, p, k_step, lamA, chunk_size, output_csv_file)
        end_time = time.time()
