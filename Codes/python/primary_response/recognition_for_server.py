...
def main():
    ...
    # output_dir = f"/Users/robertomorantovar/Dropbox/Research/Evolution_Immune_System/Text_files/primary_immune_response/sequences/output_N_ens_{N_ens}_L0_{L0}_p_{p}_k_step_{k_step}_E_lim_{E_lim}_t_lim_{t_lim}_E_m_{E_m}"
    output_dir = f"/data01/rmorantovar/text_files/primary_immune_response/H/output_N_ens_{N_ens}_N_a_{N_a}_L0_{L0}_p_{p}_k_step_{k_step}_E_lim_{E_lim}_t_lim_{t_lim}_E_m_{E_m}_seqs_{seqs}"
