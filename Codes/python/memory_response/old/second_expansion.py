...
def main():
    ...
    for antigen in antigens:    
        ...
        output_csv_file = os.path.join(output_dir, 'activated_population_with_memory_' + antigen + '_2.csv')
        ...
        if(return_data_type==1):
            ...
            data = pd.read_csv(output_dir + '/activated_population_with_memory_' + antigen + '.csv')
            clone_size_total = []
